...
<div class="container">
    ...
    <form id="form" class="frm" action="" method="post">
        ...
        <c:if test="${mode ne 'new'}">
            <button type="button" id="writeNewBtn" class="btn btn-write"><i class="fa fa-pencil"></i> 새로 글쓰기</button>
        </c:if>
...
<script>
    $(document).ready(function(){           //제목을 입력하지않고 제출했을 때 사용가능한 기능
        let formCheck = function() {
                let form = document.getElementById("form");
            if(form.title.value=="") {
                alert("제목을 입력해 주세요.");
                form.title.focus(); // 입력 필드들은 사용자가 해당 필드를 클릭하거나 탭하여 선택하면 포커스가 설정되어 입력이 가능.
                return false;
            }
